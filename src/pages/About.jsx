  ...
  return (
    <section className="max-w-5xl mx-auto sm:p-16 pb-12 !pt-[126px] px-8 min-h-[calc(100vh-80px)]">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>
          Software Developer based in India, specializingin technical education
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            ...
            teaming up with smart people. Here's my rundown:
          </p>
        </div>
        ...
        <div className="mt-12 flex">
          <VerticalTimeline>
            {experiences.map((experience) => (
              ...
              >
                <div>
                  <h3 text-black text-xl font-poppins font-semibold>
                    {experience.title}
                  </h3>
                  <p
